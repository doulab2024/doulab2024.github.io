...
const Positions =()=>{
    return <div className={'h-max w-full flex-c-n-c-c'}>
        ...
        <div className={'mt-32 text-green text-4xl font-semibold font-optima pb-10'}>—————— Join Our Team ——————</div>
        <div className={'w-4/5 flex-c-n-fs-fs'}>
            <div
                className={'font-sans text-xl text-justify mb-5'}
            >
                We are seeking passionate individuals to join our interdisciplinary team, which integrates computational biology, molecular and cell biology, and biochemistry to explore the regulatory potential of non-coding RNAs and their chemical modifications in transcription and chromatin regulation. For more details, please refer to our recent publications in <span className={'font-bold cursor-pointer italic'} onClick={() => window.open('https://www.nature.com/articles/s41586-024-07969-x', '_blank')}>Nature (2024)</span>, <span className={'font-bold cursor-pointer italic'} onClick={() => window.open('https://www.science.org/doi/full/10.1126/science.aay6018', '_blank')}>Science (2020</span>,<span className={'font-bold cursor-pointer italic'} onClick={() => window.open('https://www.science.org/doi/abs/10.1126/science.abj9090', '_blank')}> 2023)</span>, <span className={'font-bold cursor-pointer italic'} onClick={() => window.open('https://www.nature.com/articles/s41556-023-01213-w', '_blank')}>Nature Cell Biology (2023)</span>, <span className={'font-bold cursor-pointer italic'} onClick={() => window.open('https://www.nature.com/articles/s41593-023-01374-9', '_blank')}>Nature Neuroscience (2023)</span>, and <span className={'font-bold cursor-pointer italic'} onClick={() => window.open('https://www.cell.com/cancer-cell/fulltext/S1535-6108(23)00163-0', '_blank')}>Cancer Cell (2023)</span>, which have significantly advanced our understanding of regulatory non-coding RNAs—particularly repeat RNAs and their modifications—in key biological processes such as embryonic development, leukemia, and neurodegenerative diseases.
            </div>
            <div
                className={'font-sans text-xl text-justify mb-5'}
            >
            ...
            <div
                className={'font-sans text-xl text-justify mb-40'}
            >
