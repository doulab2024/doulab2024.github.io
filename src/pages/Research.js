...
const Research =()=>{
    return <div className={'h-max w-full flex-c-n-c-c'}>
        ...
        <div className={'w-4/5 flex-c-n-fs-fs'}>
            ...
            {/*/>*/}
            <div className={'font-optima text-3xl text-main font-bold pt-20'}>1. RNA methylation regulates transcription and chromatin dynamics</div>
            <div
