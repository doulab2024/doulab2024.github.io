...
const Publication =()=>{
    return <div className={'h-max w-full flex-c-n-c-c'}>
        ...
        <div className={'w-4/5 flex-c-n-fs-fs'}>
            ...
            <Paper
                title={<span>27. RNA m<sup>5</sup>C oxidation by TET2 regulates chromatin state and leukaemogenesis</span>}
            ...
            <Paper
                title={<span>26. IGF2BP3 promotes mRNA degradation through internal m<sup>7</sup>G modification</span>}
            ...
            <Paper
                title={<span>25. Chemical manipulation of m<sup>1</sup>A mediates its detection in human tRNA</span>}
            ...
            <Paper
                title={<span>24. Zebrafish Mbd5 binds to RNA m<sup>5</sup>C and regulates histone deubiquitylation and gene expression in development metabolism and behavior</span>}
            ...
            <Paper
                title={'23. KARR-seq reveals cellular higher-order RNA structures and RNA–RNA interactions'}
            ...
            <Paper
                title={'22. Profiling of RNA-binding protein binding sites by in situ reverse transcription-based sequencing'}
            ...
            <Paper
                title={<span>21. Epitranscriptional regulation of TGF-β pseudoreceptor BAMBI by m<sup>6</sup>A/YTHDF2 drives extrinsic radioresistance</span>}
            ...
            <Paper
                title={<span>20. Dysregulation of the Epitranscriptomic Mark m<sup>1</sup>A in Ischemic Stroke</span>}
            ...
            <Paper
                title={<span>16. YTHDF2/m<sup>6</sup>A/NF‐κB axis controls anti‐tumor immunity by regulating intratumoral Tregs</span>}
            ...
            <Paper
                title={'15. YTHDF2 inhibition potentiates radiotherapy antitumor efficacy'}
            ...
            <Paper
                title={'14. Quantitative sequencing using BID-seq uncovers abundant pseudouridines in mammalian mRNA at base resolution'}
            ...
            <Paper
                title={<span>13. Exon architecture controls mRNA m<sup>6</sup>A suppression and gene expression</span>}
            ...
            <Paper
                title={<span>12. Nuclear m<sup>6</sup>A reader YTHDC1 regulates the scaffold function of LINE1 RNA in mouse ESCs and early embryos</span>}
            ...
            <Paper
                title={<span>11. FTO mediates LINE1 m<sup>6</sup>A demethylation and chromatin regulation in mESCs and mouse development</span>}
            ...
            <Paper
                title={'9. DNA 5-methylcytosine-specific amplification and sequencing'}
            ...
            <div className={'font-futura text-3xl font-bold mb-14'}>Prior to 2019</div>

            <Paper
                title={'7. The strand-biased mitochondrial DNA methylome and its regulation by DNMT3A'}
            ...
            <Paper
                title={'6. Impact of dietary interventions on noncoding RNA networks and mRNAs encoding chromatin-related factors'}
            ...
            <Paper
                title={'5. Understanding super-enhancers'}
            ...
            <Paper
                title={'4. Genome-wide analysis of histone acetylation dynamics during mouse embryonic stem cell neural differentiation'}
            ...
            <Paper
                title={'3. Histone deacetylation promotes mouse neural induction by restricting Nodal-dependent mesendoderm fate'}
            ...
            <Paper
                title={'2. Integrative Epigenomics'}
            ...
            <Paper
                title={'1. Integrating genomic, epigenomic, and transcriptomic features reveals modular signatures underlying poor prognosis in ovarian cancer'}
